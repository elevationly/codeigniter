...
<div id="container" class="cf">
  <div id="col-side">
    <ul id="nav" class="cf">
      ...
      <li class="item item-purchase"> <a href="javascript:void(0);" class="purchase main-nav">抢标<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="purchase">
          </ul>
        </div>
      </li>
      <li class="item item-sales"> <a href="javascript:void(0);" class="sales main-nav">优化<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="sales">
          </ul>
        </div>
      </li>
      <li class="item item-storage"> <a href="javascript:void(0);" class="storage main-nav">工作<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
...
<script src="<?php echo base_url()?>statics/js/dist/default.js?ver=20161122"></script>
