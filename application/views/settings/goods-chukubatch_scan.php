		  ...
		  <form action="#" method="post" id="formbtn" >
			...
			<table width="700" border="1" cellspacing="0" cellpadding="0" >
				...
				<tr>
					...
					<td><input type="text" name="beizhu" class="myfile beizhu" value="<?=$billNo?>" style="width:400px;"/></th>
				</tr>
			</table><br/>
...
<script>
    ...
    function clickchukubtn(){
        if(is_chuku == 1){
            ...
            if($('#ids').val()!='' && $('input[name="sign"]').val()!=''){
                checkdatas();
                $.ajax({
