        ...
        <div id="manage-wrap" class="manage-wrap">
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    <!-- 序号、物料描述、扩展描述、补充描述、单位、单重、钢印号 -->
                    <li class="row-item">
                        <div class="label-wrap"><label for="number">物料编号</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="name">物料描述</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="name" id="name"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="spec">扩展描述</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="spec" id="spec" /></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="remark">补充描述</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="jianxing" id="jianxing" /></div>
                    </li>
                ...
                <div id="jdInfo" class="liGroup cf dn" style="display:none;">
                    <h3>维护京东仓储信息</h3>
                ...
                <div class="liGroup cf">
                    ...
                    <ul class="mod-form-rows base-form cf">
                        <li class="row-item">
                            <div class="label-wrap"><label for="unitname">单位</label></div>
                            <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="unitname" id="unitname"></div>
                        </li>
                        <li class="row-item">
                            <div class="label-wrap"><label for="unitCost">单重</label></div>
                            <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="unitCost" id="unitCost"></div>
                        </li>
                        <li class="row-item">
                            <div class="label-wrap"><label for="goods">钢印号</label></div>
                            <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="goods" id="goods"></div>
                        </li>
                        <li class="row-item">
                    ...
                    <ul class="mod-form-rows" style="display:none;" >
...
<div id="patchInputBox" class="shadow target_box dn">
    <script src="<?php echo base_url()?>statics/js/dist/material/manage.js?ver=201608191130"></script>
