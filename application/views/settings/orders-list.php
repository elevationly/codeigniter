...
<div class="wrapper">
	<div class="mod-search cf">
	    <div class="fl">
	      <ul class="ul-inline">
	        <li>
			  ...
			  <div style="position:relative;width:151px;float:left;margin-right:5px;">
				<input type="text" id="beizhu" class="ui-input ui-input-ph beizhu" placeholder="按项目备注查询" style="width:140px;">
			  </div>
			  <div style="position:relative;width:151px;float:left;margin-right:5px;">
	    ...
	    <div class="fr"><a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add">新增</a><!--<a href="#" class="ui-btn mrb" id="btn-print">打印</a>--><a class="ui-btn mrb" id="daohuo">到货</a><a class="ui-btn mrb" id="daoru">导入</a><!--<a class="ui-btn mrb" id="btn-disable">禁用</a><a class="ui-btn mrb" id="btn-enable">启用</a><a href="#" class="ui-btn mrb" id="btn-import">导入</a>--><a href="#" class="ui-btn mrb" id="btn-export">导出</a><a href="#" class="ui-btn a_del" id="btn-batchDel">删除</a></div>
	  </div>
	  <div class="cf">
...
<div class="update_box">
	...
	<form action="../right/upduser?action=upduser" method="post">
		...
		备&ensp;&ensp;&ensp;&ensp;注：<input type="text" name="beizhu" class="beizhus"/>
...
$("#Arrivaltime").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock12?action=querystock12",  
...
$("#ordernumber").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock3?action=querystock3",  
...
$("#mdescription").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock2?action=querystock2",  
...
$("#matchCon").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock?action=querystock",  
