    	...
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form" id="base-form">
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="number">项目编号</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number"></div>
    			</li>
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="name">项目名称</label></div>
                ...
                <li class="row-item odd">
                    <div class="label-wrap"><label for="wbs">WBS元素号</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="wbs" id="wbs"></div>
                </li>
                <li class="row-item odd">
                    <div class="label-wrap"><label for="gdnumber">工单号</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="gdnumber" id="gdnumber"></div>
                </li>
                <li class="row-item odd">
                    <div class="label-wrap"><label for="remark_">备注</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="remark_" id="remark_"></div>
                </li>
                <li class="row-item odd">
                    <div class="label-wrap"><label for="xd_name">下达名称</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="xd_name" id="xd_name"></div>
                </li>
                <li class="row-item odd">
                    <div class="label-wrap"><label for="xd_order">下达编号</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="xd_order" id="xd_order"></div>
                </li>
...
<script src="<?php echo base_url()?>statics/js/dist/customerManage.js?ver=201510141134"></script>
</body>
</html>
