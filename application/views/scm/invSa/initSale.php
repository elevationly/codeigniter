      ...
      <!--
		...
		<li style="display:none;">
          <label>手写签名:</label>
            ...
            <input type="hidden" class="ui-input ui-input-dis"  style="width:200px" value=""  id="sign" > 
          <script>
		//调用手写板签名返回数据
	//弹出来的签名板子
	  ...
	  $("#handwriteborder").show();
	//  $("#ldg_lockmask").show();
	   var flagvalues=$('#sign').val();
    var showurl="";
    
     if(flagvalues=="")
     {
       showurl='url:/handwrite.php';
     }
     else 
     {
        showurl='url:/showimg.php';
     }
...
//调用手写板签名结束
  ...
  <div id="initCombo" class="dn">
	...
	<input type="text" class="textbox goodssAuto" name="goodss" autocomplete="off">
	...
	<input type="text" class="textbox dingdanAuto" name="dingdan" autocomplete="off">
...
<script src="<?php echo base_url()?>statics/js/dist/sales.js?ver=201510241556"></script>
<script>
	$(function(){
		
		$(".quickAddSku").parent().parent().html("");
		$(".ordergoods").html("");
		$(".ordergoods").append("<div class='pr'><span class='ui-icon-ellipsis'></span></div>");
