...
<div class="wrapper">
  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        <dd class="pct25" style="width:80%; margin-left:15px">
          <label>项目名：</label>
          <span class="ui-combo-wrap" id="customer" style="width:530px;">
          <input type="text" name="" class="input-txt" autocomplete="off" value="" data-ref="date" style="width:530px;">
        ...
        <dd class="pct20 tc" style="margin-left:160px">
          <label>单据日期:</label>
