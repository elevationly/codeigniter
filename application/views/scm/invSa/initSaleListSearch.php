...
="ui-btn ui-btn-refresh" id="refresh" title="刷新"><b></b></a></li>
    ...
    <div class="fr">
        <a class="ui-btn mrb btn-chuku" id="btn-chuku">出库</a>
        <a class="ui-btn ui-btn-sp" id="add">新增</a>
        <a class="ui-btn" id="export" target="_blank" href="javascript:void(0);">导出</a> <!--<a href="#" class="ui-btn d_del" id="btn-batchDel">删除</a><a class="ui-btn" id="print" target="_blank"
