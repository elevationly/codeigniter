...
<table width="1500px" class="list">
  			<tr><td class='H' align="center" colspan="20"><H3>出库单汇总<H3></td></tr>
  		</table>
		<table width="1500px" class="list"  border="1">
			<thead>
				<tr>
					...
					<th width="100" align="center" colspan="2">单据类型</th>
					<th width="150" align="center" colspan="2">编号</th>
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="2"><?php echo abs($row['totalQty'])?></td>
