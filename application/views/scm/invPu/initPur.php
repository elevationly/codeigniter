...
<script src="<?php echo base_url()?>statics/js/dist/purchase.js?ver=201510241556"></script>
<script>
	$(function(){
		//$(".BillNames").html("");
		//$(".BillNames").append("<div class='pr'><span class='ui-icon-triangle-1-s'></span></div>");
	})
</script>
</body>
</html>
