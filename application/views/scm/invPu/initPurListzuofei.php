...
<script src="<?php echo base_url()?>statics/js/dist/purchaseListzuofei.js?ver=20140430"></script>
...
$("#goodsnumber").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock23?action=querystock23",  
...
$("#mdescription").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock16?action=querystock16",  
...
$("#mnumber").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock11?action=querystock11",  
...
$("#mname").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock10?action=querystock10",  
           data: { mname: mname },  
           dataType: "json",  
           success: function (data) {
				$(".show_ul2").empty();			   
...
$("#matchCon").bind("input propertychange", function () {  
       ...
       $.ajax({  
           type: "post",  
           url: "../basedata/inventory/querystock9?action=querystock9",  
