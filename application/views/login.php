...
<html>
    <head>
        ...
        <script src="<?php echo base_url()?>statics/login/<?php echo sys_skin()?>/Scripts/minijs/minicheck.js"></script>
		  <link rel="stylesheet" href="<?php echo base_url()?>statics/login/normal/style/css/bootstrap.min.css" type="text/css" media="all" />
        <link rel="stylesheet" href="<?php echo base_url()?>statics/login/normal/style/css/login.css" type="text/css" media="all" />
...
<body id="body" >
 ...
 <img class="background" />
        ...
        <div class="login">
            <div class="title">
                <div class="text">
                    <p class="text_one"><i class="glyphicon glyphicon-cloud" aria-hidden="true" ></i>电子台账</p>
                    <p class="text_two"></p>
                </div>
            </div>
            <div class="main form-horizontal">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control"   value="<?php echo get_cookie('username')?>" id="username"  placeholder="请输入账号">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">密码:</span>
                    <input type="password" class="form-control"   id="password" value="<?php echo get_cookie('userpwd')?>"  placeholder="请输入密码">
                </div>
				<div class="checkMMBox" style="display:none">
           <span class="checkbox<?php echo get_cookie('ispwd')==1?'true':'false'?>" id="Checked" onClick="ChechBoxAction(this)" val="<?php echo get_cookie('ispwd')?>" style="float:left">记住账号</span>  <div style="color:red; float:left; margin-top:5px; margin-left:10px; font-size:16px; z-index:999; line-height:16px; display:none;" id="loginerror"></div>
            </div>
				<div style="color:red; float:left; margin-top:5px; margin-left:10px; font-size:16px; z-index:999; line-height:16px; display:none;" id="loginerror"></div>

                <button type="submit" class="btn btn-success"   onclick="Login();" style="width: 100%;">安全登陆</button>
            </div>
        </div>
		   </form>
        <!--登录框结束-->
        <!--底部开始-->
        <div class="bom">
            <p>Powered by 台账 | Copyright &copy; 台账 All rights reserved.</p>
        </div>

<!--
    <div class="connext" style="margin-top:-25px">
    <form action="" onSubmit="return Login()">
        <div class="LoginBox" style="background-image:url('/statics/login/green/Images/logobg.jpg');">
...
//                }
				if (data==1) {
				    $('.loading').hide();
					top.location.href = "<?php echo site_url('home/index')?>";
				} else {
 ...
 <!--底部结束-->
        <script src="<?php echo base_url()?>statics/login/normal/style/js/jquery.min.js" type="text/javascript" charset="utf-8"></script>
       
        <script src="<?php echo base_url()?>statics/login/normal/style/js/login.js" type="text/javascript" charset="utf-8"></script>    
</body>
</html>
