...
<div class="wrapper">
  <div class="mod-search cf">
    <div class="fl">
	  ...
	  <!--
		...
		<li>
          <label>采购订单号:</label>
          <input type="text" id="ordernumber" class="ui-input w200">
        </li>
        <li id="chkField">
 ...
 value='isSerNum'>序列号商品</label>
    ...
    <div class="fr">
        <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add">新增</a><a class="ui-btn mrb" id="daoru">导入</a><a class="ui-btn mrb" id="export">导出系统库存</a><!--<a class="ui-btn mrb" id="import">导入盘点库存</a>--><a class
