...
var SYSTEM = {
	...
	//requiredCheckStore:1<?php echo $system['requiredCheckStore']?>, //是否检查负库存  1：是、0：否
...
function getDjtype() {
	if(true) {
		Public.ajaxGet('<?php echo site_url()?>/basedata/djtype?action=list&isDelete=2', {}, function(data){
			if(data.status === 200) {
				SYSTEM.djtypeInfo = data.data.items;
			} else if (data.status === 250){
				SYSTEM.djtypeInfo = [];
			} else {
				Public.tips({type: 1, content : data.msg});
...
function getDingdan() {
	if(true) {
		Public.ajaxGet('<?php echo site_url()?>/basedata/dingdan?action=list&isDelete=2', {}, function(data){
			if(data.status === 200) {
				SYSTEM.dingdanInfo = data.data.items;
			} else if (data.status === 250){
				SYSTEM.dingdanInfo = [];
			} else {
				Public.tips({type: 1, content : data.msg});
...
<div id="container" class="cf">
  <div id="col-side">
    ...
    <li class="item item-vip"> <a href="javascript:void(0);" class="vip main-nav">高级<span class="arrow">&gt;</span></a>
      ...
      <li class="item item-purchase"> <a  tabid="purchase-purchase" rel="pageTab" href="../scm/invPu?action=initPur" data-right="PU_ADD"  class="purchase main-nav">出库单<span class="arrow">&gt;</span></a>
        ...
        <li class="item item-purchase">
            <a tabid="lading-lading" rel="pageTab" href="../scm/lading?action=initPur" data-right="LADING_ADD"  class="lading main-nav">提货单<span class="arrow">&gt;</span></a>
            <div class="sub-nav-wrap single-nav">
                <ul class="sub-nav" id="lading">
                </ul>
            </div>
        </li>
      <li class="item item-sales"> <a tabid="sales-sales" rel="pageTab" href="../scm/invSa?action=initSale&amp;transType=150602" data-right="SA_ADD"   class="sales main-nav">领料单<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="sales">
          </ul>
        </div>
      </li>
      <li class="item item-storage"> <a  tabid="storage-otherWarehouses" rel="pageTab" href="../settings/orders_list" data-right="INVENTORY_QUERY" class="storage main-nav">物资库<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="storage">
          </ul>
        </div>
      </li>           
      <li class="item item-money"> <a   tabid="money-receipt" rel="pageTab" href="../settings/staff_list" data-right="STAFF_QUERY" target="index" class="money main-nav">领料人<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
      ...
      <li class="item item-report"> <a   tabid="report-salesOrderTracking" rel="pageTab" href="../settings/customer_list" data-right="BU_QUERY" class="report main-nav">项目库<span class="arrow">&gt;</span></a>
	 ...
	 <li class="item item-money"> <a   tabid="money-receipt" rel="pageTab" href="../settings/cangku_list" data-right="QTSR_QUERY" target="index" class="moneys main-nav">仓储物资库<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="cangku"> 
          </ul>
        </div>
      </li>
