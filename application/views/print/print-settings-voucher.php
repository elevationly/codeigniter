...
<div class="print-settings-wrap">
  ...
  <div class="settings-ctn" id="printSettings">
      <div class="item">
        <p class="print-tips">为了保证您的正常打印，请先下载安装<a href="/data/upfile/readerdc_cn_ra_cra_install.exe" target="_blank">Adobe PDF阅读器</a></p>
      ...
      <div class="item taoda-settings" id="taodaSettings" style="display:none">
        <p class="print-tips" id="taodaTips">为了保证您的正常打印，请先下载安装<a href="/data/upfile/readerdc_cn_ra_cra_install.exe" target="_blank">软江打印工具</a></p>
