...
function getCustomerData() {
	var a = getEntriesData(),
		...
		c = {
			...
			name: $.trim($("#name").val()),
            wbs: $.trim($("#wbs").val()),
            gdnumber: $.trim($("#gdnumber").val()),
            remark_: $.trim($("#remark_").val()),
            xd_name: $.trim($("#xd_name").val()),
            xd_order: $.trim($("#xd_order").val()),
...
function initField() {
	if ($("#note").placeholder(), "edit" == oper) {
		...
		if ($("#number").val(rowData.number), $("#name").val(rowData.name), $("#xd_name").val(rowData.xd_name), $("#xd_order").val(rowData.xd_order), $("#wbs").val(rowData.wbs),$("#remark_").val(rowData.remark_), $("#gdnumber").val(rowData.gdnumber),$("#category").data("defItem", ["id", rowData.cCategory]), rowData.beginDate) {
