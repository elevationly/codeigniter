...
var api = frameElement.api,
	...
	THISPAGE = {
		...
		loadGrid: function() {
			...
			$("#grid").jqGrid({
				url: "../basedata/inventory/order?action=order&dingdanhao="+ordert,
		...
		addEvent: function() {
			...
			$(".grid-wrap").on("click", ".ui-icon-search", function(a) {
				...
				queryConditions.catId = a.catId, queryConditions.skey = "" === a.$_matchCon.val() ? "" : a.$_matchCon.val(), a.reloadData(queryConditions)
