	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			var c = '<a id="savaAndAdd" class="ui-btn ui-btn-sp">保存并新增</a><a id="save" class="ui-btn">保存</a>',
				...
				f = "",
				g = "",
				h = "150502" == originalData.transType ? "生成退货单" : "生成物资出库单",
			...
			this.customerCombo.input.enterKey(), this.$_date.bind("keydown", function(b) {
				...
				if (b.preventDefault(), Business.verifyRight("PO_CHECK")) {
					...
					d && c.ajaxPost("../scm/invPo/checkInvPo?action=checkInvPo", {
						...
						200 === b.status ? (originalData.id = b.data.id, $("#mark").addClass("has-audit"), a.$_checkName.html(SYSTEM.realName).parent().show(), a.disableEdit(), $("#groupBtn").html(a.btn_turn + a.btn_view + a.btn_reaudit + a.btn_close), "150502" == a.classes.getValue() ? $("#turn").html("生成退货单") : $("#turn").html("生成物资出库单"), parent.Public.tips({
							content: "审核成功！"
						})) : parent.Public.tips({
							type: 1,
							content: b.msg
				...
				if (b.preventDefault(), Business.verifyRight("PO_CLOSE")) {
					...
					d && c.ajaxPost("../scm/invPo/batchClose?action=batchClose", {
						...
						200 === b.status && b.msg && b.msg.length ? 1 == b.msg[0].isSuccess ? ($("#mark").addClass("has-closed'has-closed'"), a.disableEdit(), $("#groupBtn").html(a.btn_view + a.btn_open), "150502" == a.classes.getValue() ? $("#turn").html("生成退货单") : $("#turn").html("生成物资出库单"), parent.Public.tips({
							content: "关闭成功！"
						})) : parent.Public.tips({
							type: 1,
				...
				if (b.preventDefault(), Business.verifyRight("PO_UNCLOSE")) {
					...
					c.ajaxPost("../scm/invPo/rebatchClose?action=rebatchClose", {
						...
						200 === b.status && b.msg && b.msg.length ? 1 == b.msg[0].isSuccess ? ($("#mark").removeClass("has-closed"), a.enableEdit(), $("#groupBtn").html((billRequiredCheck ? a.btn_turn : "") + a.btn_edit + a.btn_reaudit + a.btn_close), "150502" == a.classes.getValue() ? $("#turn").html("生成退货单") : $("#turn").html("生成物资出库单"), parent.Public.tips({
							content: "开启成功！"
						})) : parent.Public.tips({
							type: 1,
