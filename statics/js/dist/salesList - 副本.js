...
var THISPAGE = {
    ...
    chuku(danjuBianhao);
		...
		$("#grid").jqGrid({
			...
			gridview: !0,
			multiselect: !0,
			colNames: [/*"操作", */"物料编号","物料描述", "数量","单位","单价", "总金额","采购订单号","单据类型","编号", "项目名"/*, "已" + c + "款"*/, "领料人"/*,"备注"*/, "单据日期", "仓库位置", "超期时间提示", "出库状态",
				"项目类别", "项目状态", "是否下达", "是否报审", "是否核对",
				"订单来源"],
			colModel: [/*{
				name: "operating",
				width: 60,
		...
		$("#grid").jqGrid({
			...
			gridview: !0,
			multiselect: !0,
			colNames: ["操作", "单据日期", "单据编号", "项目名"/*, "总数量", "总金额", "已" + c + "款"*/, "领料人", "制单人", "审核人", "仓库","备注","超期时间提示","出库状态确定", "订单来源"],
			colModel: [{
    name: "operating",
    width: 80,
    fixed: !0,
    formatter: function(cellValue, options, rowObject) {
        var btnHtml = "<button class='ui-label ui-label-success handle-danju-click' data-rowid='" + options.rowId + "'>单据出库</button>";
        return btnHtml;
    },
    align: "center",
    sortable: !1
