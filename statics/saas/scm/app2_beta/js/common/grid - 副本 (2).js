...
! function ($) {
    ...
    $.jgrid = $.jgrid || {}, $.extend($.jgrid, {
        ...
        getGridParam: function (a) {
			...
			//alert(c);
			//alert("xxxxxxxxxxxxxxxxxxxxxxxx========可编辑单元格=");
            return this.each(function () {
                var g, h, i = this,
                    j = -1;
			...
			/*var as=this;
			 var ks = $(as).jqGrid("getGridRowById", a);
					//alert(ks.innerHTML);
				$(ks).find(".ordergoods").text(nametext);*/
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            case "custom":
				...
				//alert($(this).find("tr").find("td").text());
                try {
					...
					if(Cts.indexOf("goodsnumber") > 0 ){
						//alert(nametext);
						$(y).val(nametext);
						//$(y).parent().parent().html(nametext);
					}
        ...
        editCellByColName: function (b, c, d) {
			...
			/*var as=this;
			 var ks = $(as).jqGrid("getGridRowById", b);
					//alert(ks.innerHTML);
					nametext=$(ks).find(".ordergoods").text();
