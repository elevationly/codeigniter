        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                if (0 === this.p.colNames.length)
                    for (e = 0; e < this.p.colModel.length; e++) this.p.colNames[e] = this.p.colModel[e].label || this.p.colModel[e].name, this.p.colModel[e].nameExt && (this.p.colNames[e] += this.p.colModel[e].nameExt);
                ...
                var j = ["shiftKey", "altKey", "ctrlKey"],
                    ...
                    r = function (a) {
                        var b, d, e = [],
                            f = 0;
                        for (d = 0; d < c.p.colModel.length; d++) b = c.p.colModel[d], "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (e[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name, c.p.keyName !== !1 && b.key === !0 && (c.p.keyName = e[f]), f++);
                        return e
                    },
                    s = function (a) {
                    ...
                    u = function (a) {
                        ...
                        if (b = c.p.keyName === !1 || c.p.loadonce === !0 ? c.p.localReader.id : c.p.keyName, "delete" === a) {
                            ...
                            for (d = 0; f > d; d++) e = $.jgrid.getAccessor(c.p.data[d], b), void 0 === e && (e = String(d + 1)), c.p._index[e] = d
                    },
                    ...
                    w = function (a, b, d, e, f) {
                        ...
                        if (h && (c.p.data = [], c.p._index = {}, c.p.localReader.id = i), c.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            c.p.subGrid === !0 && (G = 1, w = $.jgrid.getMethod("addSubGridCell")), j.repeatitems || (I = r(l)), x = c.p.keyName === !1 ? $.isFunction(j.id) ? j.id.call(c, a) : j.id : c.p.keyName, y = -1 === String(x).indexOf("[") ? I.length ? function (a, b) {
                                return $(x, a).text() || b
                            } : function (a, b) {
                    ...
                    x = function (a, b, d, e, f) {
                        ...
                        if (a) {
                            ...
                            c.p.page = k($.jgrid.getAccessor(a, h.page), c.p.page), c.p.lastpage = k($.jgrid.getAccessor(a, h.total), 1), c.p.records = k($.jgrid.getAccessor(a, h.records)), c.p.userData = $.jgrid.getAccessor(a, h.userdata) || {}, J && (x = $.jgrid.getMethod("addSubGridCell")), B = c.p.keyName === !1 ? $.isFunction(h.id) ? h.id.call(c, a) : h.id : c.p.keyName, A = $.jgrid.getAccessor(a, h.root), null == A && $.isArray(a) && (A = a), A || (A = []), z = A.length, n = 0, z > 0 && c.p.page <= 0 && (c.p.page = 1);
                    ...
                    E = function (a, b) {
                        ...
                        if (a = a.substr(1), b += "_" + a, d = "pg_" + a, e = a + "_left", g = a + "_center", h = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + d + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + e + "' align='left'></td><td id='" + g + "' align='center' style='white-space:pre;'></td><td id='" + h + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), c.p.rowList.length > 0) {
                            p = "<td dir='" + f + "'>", p += "<select class='ui-pg-selbox' role='listbox'>";
                            var r;
                            for (l = 0; l < c.p.rowList.length; l++) r = c.p.rowList[l].toString().split(":"), 1 === r.length && (r[1] = r[0]), p += '<option role="option" value="' + r[0] + '"' + (k(c.p.rowNum, 0) === k(r[0], 0) ? ' selected="selected"' : "") + ">" + r[1] + "</option>";
                            p += "</select></td>"
                        }
                        if ("rtl" === f && (o += p), c.p.pginput === !0 && (n = "<td dir='" + f + "'>" + $.jgrid.format(c.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), c.p.pgbuttons === !0) {
                            ...
                            "rtl" === f && s.reverse(), o += "<td id='" + s[0] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-first'></span></td>", o += "<td id='" + s[1] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-prev'></span></td>", o += "" !== n ? m + n + m : "", o += "<td id='" + s[2] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-next'></span></td>", o += "<td id='" + s[3] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-end'></span></td>"
                        } else "" !== n && (o += n);
                ...
                for (this.p.id = this.id, -1 === $.inArray(c.p.multikey, j) && (c.p.multikey = !1), c.p.keyName = !1, e = 0; e < c.p.colModel.length; e++) c.p.colModel[e] = $.extend(!0, {}, c.p.cmTemplate, c.p.colModel[e].template || {}, c.p.colModel[e]), c.p.keyName === !1 && c.p.colModel[e].key === !0 && (c.p.keyName = c.p.colModel[e].name);
                    ...
                    if (d = d === !1 || "stop" === d ? !1 : !0, d && $.isFunction(c.p.beforeSelectRow) && (d = c.p.beforeSelectRow.call(c, T[0].id, a)), "A" !== S.tagName && ("INPUT" !== S.tagName && "TEXTAREA" !== S.tagName && "OPTION" !== S.tagName && "SELECT" !== S.tagName || b) && d === !0)
                        ...
                        if (b) $(c).jqGrid("setSelection", ma, !0, a);
                            ...
                            $(c.p.selarrrow).each(function (a, b) {
                                ...
                                d && $(d).removeClass("ui-state-highlight"), $("#jqg_" + $.jgrid.jqID(c.p.id) + "_" + $.jgrid.jqID(b))[c.p.useProp ? "prop" : "attr"]("checked", !1), f && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f)).removeClass("ui-state-highlight"), $("#jqg_" + $.jgrid.jqID(c.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f))[c.p.useProp ? "prop" : "attr"]("checked", !1))
                ...
                } else $(d.cDiv).hide(), $(d.hDiv).addClass("ui-corner-top");
            ...
            return this.each(function () {
                ...
                if (b) try {
                    if ($(this.p.colModel).each(function (c) {
                        ...
                        if (void 0 !== f)
                            if (k[d] = this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? $.unformat.date.call(i, f, this) : f, g = i.formatter(a, f, c, b, "edit"), e = this.title ? {
                                ...
                                var j = $("td[role='gridcell']:eq(" + c + ")", h),
                                    l = j.find("input");
                                if (l.length) {
                                    if (g = "&#160;" === g ? "" : g, l.val(g).select(), "function" == typeof l.getCombo) {
                                        var m = l.getCombo();
                                        m && m.selectByText(g)
                                    }
                                } else j.html(g);
                        ...
                        h = function (d, f, g) {
                            ...
                            k += "</ul>", a("body").append(k), a("#sopt_menu").addClass("ui-menu ui-widget ui-widget-content ui-corner-all"), a("#sopt_menu > li > a").hover(function () {
                                ...
                                var g = a(this).attr("value"),
                                    h = a(this).attr("oper");
                                if (a(c).triggerHandler("jqGridToolbarSelectOper", [g, h, d]), a("#sopt_menu").hide(), a(d).text(h).attr("soper", g), b.autosearch === !0) {
                        ...
                        if (this.hidden === !0 && a(p).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), g = a.extend({}, this.searchoptions || {}), this.search) {
                            ...
                            case "custom":
                                ...
                                try {
                                    ...
                                    if (!D) throw "e2";
                                    D = a(D).addClass("customelement"), a(q).find("span[name='" + (m.index || m.name) + "']").append(D)
                                } catch (E) {
                    ...
                    if (b.p.subGrid !== !0 && b.p.treeGrid !== !0 && b.p.cellEdit !== !0 && !b.p.sortable && !b.p.scroll) {
                        ...
                        if (f >= 0 && g) {
                            ...
                            if (b.p.groupHeader) {
                                ...
                                b.grid.fsDiv = a('<div style="position:absolute;left:0px;top:' + (parseInt(h, 10) + parseInt(i, 10) + parseInt(o, 10) + 1) + 'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'), a("#gview_" + a.jgrid.jqID(b.p.id)).append(b.grid.fsDiv);
                                var p = a(".ui-jqgrid-ftable", "#gview_" + a.jgrid.jqID(b.p.id)).clone(!0);
                                a("tr", p).each(function () {
                                    a("td:gt(" + f + ")", this).remove()
                                }), a(p).width(1), a(b.grid.fsDiv).append(p)
                            }
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            if (f.buttons.length > 0)
                for (i = 0; i < f.buttons.length; i++) void 0 === f.buttons[i].id && (f.buttons[i].id = "info_button_" + i), j += "<a href='javascript:void(0)' id='" + f.buttons[i].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[i].text + "</a>";
            ...
            var d = this;
            a.isFunction(c.dataInit) && c.dataInit.call(d, b), c.dataEvents && a.each(c.dataEvents, function () {
            ...
            case "button":
                ...
                x = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, g(h, c), "button" !== b && (e ? c.size || a(h).css({
                    width: "100%"
                }) : c.size || (c.size = 20)), a(h).attr("role", x).addClass(x);
                break;
            case "image":
            case "file":
            ...
            case "custom":
                ...
                try {
                    ...
                    y = a(y).addClass("customelement").attr({
                        id: c.id,
                        name: c.name
                    }), a(h).addClass("pr").empty().append(y), c.trigger && a(h).append('<span class="' + c.trigger + '"></span>')
					if((nametext!="" && ($(y).attr("class")!="textbox djtypeAuto customelement" && $(y).attr("class")!="textbox djtypeAuto customelement ui-combo-active")) || (nametext2!="" && ($(y).attr("class")!="textbox djtypeAuto customelement" && $(y).attr("class")!="textbox djtypeAuto customelement ui-combo-active"))){
						//alert(nametext3);
						//alert($(y).attr("class"));
						if(nametext!=""){
							$(y).val(nametext);
...
function (a) {
    ...
    a.jgrid.extend({
        editCellByColName: function (b, c, d) {
            return this.each(function () {
                var e, f, g = this;
                if (e = a(g.rows[b + ""]).index(), a(g.rows).each(function (c) {
                    var d = a(this);
                    d[0].id === b && (e = d.index())
                }), e)
                    if (a.each(g.p.colModel, function (a, b) {
                        if (b.name === c)
                            if (b.hidden) {
                                var d = g.p.colModel.length - 1;
                                d = d > a ? a : d - 1, c = g.p.colModel[d + 1].name
                            } else f = a
				...
				var as=this;
				var ks = $(as).jqGrid("getGridRowById", b);
					//alert(ks.innerHTML);
				nametext=$(ks).find(".goods").text();
				nametext2=$(ks).find(".dingdanhao").text();
			//	nametext3=$(ks).find(".ordergoods").text();
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    if (c = parseInt(c, 10), i.p.selrow = i.rows[b].id, i.p.knv || a(i).jqGrid("GridNav"), i.p.savedRow.length > 0) {
                        ...
                        if (g = a("td:eq(" + c + ")", i.rows[b]), h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell")) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && (a("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow]).removeClass("edit-cell ui-state-highlight"), a(i.rows[i.p.iRow]).removeClass("selected-row ui-state-hover")), g.addClass("edit-cell ui-state-highlight"), a(i.rows[b]).addClass("selected-row ui-state-hover"), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c);
                            ...
                            a(i).triggerHandler("jqGridBeforeEditCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.beforeEditCell) && i.p.beforeEditCell.call(i, i.rows[b].id, e, f, b, c), a(g).html("").append(m).attr("tabindex", "0"), a.jgrid.bindEv.call(i, m, l), window.setTimeout(function () {
                                a.isFunction(l.custom_element) ? a(":input", m).select().focus() : a(m).select().focus()
                            }, 20), a("input, select, textarea", g).unbind("keydown.once").bind("keydown.once", function (d) {
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        if (g !== e.p.savedRow[d].v) {
                            ...
                            if (r[0] === !0) {
                                ...
                                if (a.isFunction(e.p.beforeSubmitCell) && (s = e.p.beforeSubmitCell.call(e, e.rows[b].id, j, f, b, c),
                                    s || (s = {})), a("input.hasDatepicker", h).length > 0 && a("input.hasDatepicker", h).datepicker("hide"), "remote" === e.p.cellsubmit)
                                    if (e.p.cellurl) {
                                        var t = {};
                    ...
                    window.setTimeout(function () {
                        a("#" + a.jgrid.jqID(e.p.knv)).attr("tabindex", "-1"), a("td:eq(" + e.p.iCol + ")", e.rows[e.p.iRow]).removeClass("edit-cell ui-state-highlight")
                    }, 0)
                }
            })
        }, saveCells: function () {
            return this.each(function () {
                var b = this;
                if (b.grid && b.p.cellEdit === !0 && b.p.savedRow.length >= 1)
                    for (var c = 0; c < b.p.savedRow.length; c++) {
                        var d = b.p.savedRow[c];
                        a(b).jqGrid("saveCell", d.id, d.ic)
                    }
            })
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        "custom" === f.edittype && a.isFunction(f.editoptions.handle) && f.editoptions.handle(), a(g).empty().attr("tabindex", "-1"), a(e).jqGrid("setCell", e.rows[b].id, c, e.p.savedRow[d].v, !1, !1, !0), a(e).triggerHandler("jqGridAfterRestoreCell", [e.rows[b].id, e.p.savedRow[d].v, b, c]), a.isFunction(e.p.afterRestoreCell) && e.p.afterRestoreCell.call(e, e.rows[b].id, e.p.savedRow[d].v, b, c), e.p.savedRow.splice(0, 1)
                    }
                    window.setTimeout(function () {
                        a("#" + e.p.knv).attr("tabindex", "-1"), a("td:eq(" + e.p.iCol + ")", e.rows[e.p.iRow]).removeClass("edit-cell ui-state-highlight")
                    }, 0)
                }
            })
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    for (d = c + 1; d < e.p.colModel.length; d++)
                        if (e.p.colModel[d].editable === !0 && !e.p.colModel[d].hidden) {
                            f = d;
                            break
                        }
                    if (d === e.p.colModel.length) {
                        if (b = Number(b) + 1, 0 === a(e).find("tbody tr").eq(b).length) {
                            if (e.p.triggerAdd === !1) return b -= 1, void a(e).jqGrid("saveCell", b, c);
                            "fixedGrid" !== a(e).attr("id") && (a(e).data("newId") ? (a(e).jqGrid("addRowData", a(e).data("newId"), {
                                id: a(e).data("newId")
                            }, "last"), a(e).data("newId", a(e).data("newId") + 1)) : THISPAGE && THISPAGE.newId ? (a(e).jqGrid("addRowData", THISPAGE.newId, {
                                id: THISPAGE.newId
                            }, "last"), THISPAGE.newId++) : a(e).jqGrid("addRowData", b, {}, "last"))
                        }
                        for (d = 0; d < e.p.colModel.length; d++)
                            if (e.p.colModel[d].editable === !0 && !e.p.colModel[d].hidden) {
                                f = d;
                                break
                            }
            ...
            return this.each(function () {
                ...
                if (c.grid) {
                    var d = b + 1,
                        e = a(c).jqGrid("getRowData", b),
                        f = a(c).find("#" + b).data();
                    a(c).data("newId") ? (d = a(c).data("newId"), c.data("newId", ++d)) : THISPAGE && THISPAGE.newId && (d = THISPAGE.newId, THISPAGE.newId++), a(c).jqGrid("addRowData", d, e, "after", b), a(c).find("#" + d).data(f)
                }
            })
    ...
    a.jgrid.extend({
        searchGrid: function (b) {
            return b = a.extend(!0, {
                ...
                function c(c) {
                    f = a(d).triggerHandler("jqGridFilterBeforeShow", [c]), void 0 === f && (f = !0), f && a.isFunction(b.beforeShowSearch) && (f = b.beforeShowSearch.call(d, c)), f && (a.jgrid.viewModal("#" + a.jgrid.jqID(g.themodal), {
                ...
                if (d.grid) {
                    ...
                    if ("string" == typeof h && (h = a.jgrid.parse(h)), b.recreateFilter === !0 && a("#" + a.jgrid.jqID(g.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(g.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+d.p.id)));
                        ...
                        var l, m, n = a.extend([], d.p.colModel),
                            ...
                            s = !1,
                            t = -1;
                        if (b.showQuery && (q = "<a href='javascript:void(0)' id='" + e + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>"), b.columns.length ? (n = b.columns, t = 0, l = n[0].index || n[0].name) : a.each(n, function (a, b) {
                            if (b.label || (b.label = d.p.colNames[a]), !s) {
                                var c = void 0 === b.search ? !0 : b.search,
                                    e = b.hidden === !0,
                                    f = b.searchoptions && b.searchoptions.searchhidden === !0;
                                (f && c || c && !e) && (s = !0, l = b.index || b.name, t = a)
                            }
                        }), !h && l || b.multipleSearch === !1) {
                            var u = "eq";
                            t >= 0 && n[t].searchoptions && n[t].searchoptions.sopt ? u = n[t].searchoptions.sopt[0] : b.sopt && b.sopt.length && (u = b.sopt[0]), h = {
                                groupOp: "AND",
                                rules: [{
                                    field: l,
                                    op: u,
                        ...
                        s = !1, b.tmplNames && b.tmplNames.length && (s = !0, r = b.tmplLabel, r += "<select class='ui-template'>", r += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                        ...
                        }), r += "</select>"), m = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + e + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + j + "'>" + p + r + "</td><td class='EditButton' " + k + ">" + q + o + "</td></tr></tbody></table>", e = a.jgrid.jqID(e), a("#" + e).jqFilter({
                            columns: n,
                            ...
                            id: d.p.id
                        }), i.append(m), s && b.tmplFilters && b.tmplFilters.length && a(".ui-template", i).bind("change", function () {
                            var c = a(this).val();
                            return "default" === c ? a("#" + e).jqFilter("addFilter", h) : a("#" + e).jqFilter("addFilter", b.tmplFilters[parseInt(c, 10)]), !1
                        }), b.multipleGroup === !0 && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + e)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + e)), b.gbox = "#gbox_" + e, b.layer ? a.jgrid.createModal(g, i, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(g, i, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]), (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(g.themodal)).keydown(function (c) {
                            var d = a(c.target);
                            ...
                            return a(".queryresult", i).toggle(), !1
                            ...
                            if (b.stringResult) {
                                ...
                                "string" == typeof c && (h[b.sFilter] = c, a.each([b.sField, b.sValue, b.sOper], function () {
                                    h[this] = ""
                                }))
                            } else b.multipleSearch ? (h[b.sFilter] = i, a.each([b.sField, b.sValue, b.sOper], function () {
                                h[this] = ""
                            })) : (h[b.sField] = i.rules[0].field, h[b.sValue] = i.rules[0].data, h[b.sOper] = i.rules[0].op, h[b.sFilter] = "");
                            return d.p.search = !0, a.extend(d.p.postData, h), a(d).triggerHandler("jqGridFilterSearch"), a.isFunction(b.onSearch) && b.onSearch.call(d), a(d).trigger("reloadGrid", [{
                                page: 1
                            ...
                            var c = {},
                                f = a("#" + e);
                            return d.p.search = !1, b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", f[0].resetFilter(), s && a(".ui-template", i).val("default"), a.extend(d.p.postData, c), a(d).triggerHandler("jqGridFilterReset"), a.isFunction(b.onReset) && b.onReset.call(d), a(d).trigger("reloadGrid", [{
                                page: 1
                            }]), !1
                        }), c(a("#" + e)), a(".fm-button:not(.ui-state-disabled)", i).hover(function () {
                            a(this).addClass("ui-state-hover")
                        }, function () {
                            a(this).removeClass("ui-state-hover")
                        })
            ...
            return d = a.extend(!0, {
                ...
                function f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (m) {
                        if (g = this.name, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", "cb" !== g && "subgrid" !== g && this.editable === !0 && "rn" !== g) {
                            ...
                            0 === i.length && (i = a("<tr " + k + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + g), a(i).append(s), a(e).append(i), i[0].rp = w), a("td:eq(" + (x - 2) + ")", i[0]).html(void 0 === v.label ? d.p.colNames[m] : v.label), a("td:eq(" + (x - 1) + ")", i[0]).append(v.elmprefix).append(l).append(v.elmsuffix), a.isFunction(u.custom_value) && "_empty" !== c && u.custom_value.call(o, a("#" + g, "#" + t), "set", j), a.jgrid.bindEv.call(o, l, u), p[n] = m, n++
                        }
                    }), n > 0) {
                ...
                function g(c, d, e) {
                    ...
                    if ("_empty" === c) return a(m).each(function () {
                        f = this.name, i = a.extend({}, this.editoptions || {}), h = a("#" + a.jgrid.jqID(f), "#" + e), h && h.length && null !== h[0] && (j = "", i.defaultValue ? (j = a.isFunction(i.defaultValue) ? i.defaultValue.call(o) : i.defaultValue, "checkbox" === h[0].type ? (k = j.toLowerCase(), k.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== k ? (h[0].checked = !0, h[0].defaultChecked = !0, h[0].value = j) : (h[0].checked = !1, h[0].defaultChecked = !1)) : h.val(j)) : "checkbox" === h[0].type ? (h[0].checked = !1, h[0].defaultChecked = !1, j = a(h).attr("offval")) : h[0].type && "select" === h[0].type.substr(0, 6) ? h[0].selectedIndex = 0 : h.val(j), (b[o.p.id].checkOnSubmit === !0 || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData[f] = j))
                    }), void a("#id_g", "#" + e).val(c);
                ...
                if (o.grid && c) {
                    var p, q, r, s = o.p.id,
                        ...
                        C = 1,
                        D = 0;
                    t = a.jgrid.jqID(t), "new" === c ? (c = "_empty", r = "add", d.caption = b[o.p.id].addCaption) : (d.caption = b[o.p.id].editCaption, r = "edit"), d.recreateForm === !0 && void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0] && a("#" + a.jgrid.jqID(w.themodal)).remove();
                    var E = !0;
                    if (d.checkOnUpdate && d.jqModal && !d.modal && (E = !1), void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0]) {
                        ...
                        if (a.jgrid.createModal(w, U, d, "#gview_" + a.jgrid.jqID(o.p.id), a("#gbox_" + a.jgrid.jqID(o.p.id))[0]),
                            K && (a("#pData, #nData", v + "_2").css("float", "right"), a(".EditButton", v + "_2").css("text-align", "left")), b[o.p.id].topinfo && a(".tinfo", v).show(), b[o.p.id].bottominfo && a(".binfo", v + "_2").show(), U = null, R = null, a("#" + a.jgrid.jqID(w.themodal)).keydown(function (c) {
                                var e = c.target;
                    ...
                    if (l.grid && "string" == typeof b) {
                        ...
                        for (c.cloneToTop && l.p.toppager && (n = 2), m = 0; n > m; m++) {
                            ...
                            0 === m ? (r = b, s = l.p.id, r === l.p.toppager && (s += "_top", n = 1)) : (r = l.p.toppager, s = l.p.id + "_top"), "rtl" === l.p.direction && a(t).attr("dir", "rtl").css("float", "right"), c.add && (e = e || {}, q = a("<td class='ui-pg-button ui-corner-all'></td>"), a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                ...
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    a.isFunction(c.beforeRefresh) && c.beforeRefresh.call(l), l.p.search = !1;
                                    try {
                                        var b = l.p.id;
        ...
        setTreeNode: function (b, c) {
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    a(d).each(function () {
                        ...
                        a(f.namedItem(b)).css("display", ""), this[e] && a(c).jqGrid("expandRow", this)
                    })
                }
            })
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    a(d).each(function () {
                        var b = c.p.idPrefix + a.jgrid.getAccessor(this, c.p.localReader.id);
                        a(f.namedItem(b)).css("display", "none"), this[e] && a(c).jqGrid("collapseRow", this)
                    })
                }
            })
...
function (a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
            ...
            if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
                ...
                if (a.fmatter.isNumber(c.decimalPlaces)) {
                    ...
                    if (d = f.lastIndexOf("."), -1 != d) {
                        ...
                        k = k > 8 ? 8 : k, j = Math.pow(10, k)
                    }
                    if (f = String(Math.round(b * j * i / j) / i), d = f.lastIndexOf("."), h > 0)
                ...
                if (c.thousandsSeparator) {
                    ...
                    var m, n = f.substring(d),
                        o = -1;
                    for (m = d; m > 0; m--) o++, o % 3 === 0 && m !== d && (!e || m > 1) && (n = l + n), n = f.charAt(m - 1) + n;
                    f = n
                }
        ...
        var d, e = {
            ...
            f = "";
        if (void 0 !== c.colModel && void 0 !== c.colModel.formatoptions && (e = a.extend({}, e, c.colModel.formatoptions)), e.target && (f = "target=" + e.target), d = e.baseLinkUrl + e.showAction + "?" + e.idName + "=" + c.rowId + e.addParam, a.fmatter.isString(b) || a.fmatter.isNumber(b)) {
            if (e.pageTab) {
                var g = ["rel=pageTab"];
                return e.parentopen && g.push("parentopen=true", "tabtxt=" + e.tabtxt), "<a " + f + ' href="' + d + '"' + g.join(" ") + ">" + b + "</a>"
            }
        ...
        return void 0 !== c.colModel && void 0 !== c.colModel.formatoptions && (d = a.extend({}, d, c.colModel.formatoptions)), a.fmatter.isEmpty(b) ? d.defaultValue : 0 !== Number(b) || d.showZero ? a.fmatter.util.NumberFormat(b, d) : "&#160;"
        ...
        return "" === a.jgrid.htmlDecode(f) && (f = ""), void 0 !== f ? f : e === !0 ? a(b).text() : a.jgrid.htmlDecode(a(b).html())
