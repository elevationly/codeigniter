...
lhgdialog.daohuo = function( content, yes, value, parent )
{
	value = value || '';
	var input;
	var input2;
	...
	return lhgdialog({
		...
		content: [
			...
			'<div>',
				'<input type="text" value="',
					value,
				'" style="width:18em;padding:6px 4px" />',
				'<br/><span>到货时间</span><br/><input type="text" class="sang_Calender" value="',
					value,
				'" style="width:18em;padding:6px 4px" />',
			'</div>'
			].join(''),
		init: function(){
			input = this.DOM.content[0].getElementsByTagName('input')[0];
			input2 = this.DOM.content[0].getElementsByTagName('input')[1];
			
			//input.select();
			input.focus();
		},
		ok: function(here){
			input3=input.value+","+input2.value;
			return yes && yes.call(this, input3, here);
		},
		cancel: true
	});
};

lhgdialog.chuku = function( content, yes, value, parent )
{
	value = value || '';
	var input;
	var input2;
	...
	return lhgdialog({
		...
		content: [
			...
			'<div>',
				'<input type="text" value="',
					value,
				'" style="width:18em;padding:6px 4px" />',
				'<br/><span>领用数量</span><br/><input type="text" value="',
					value,
				'" style="width:18em;padding:6px 4px" />',
				'<br/><span>出库时间</span><br/><input type="text" value="',
					value,
				'" style="width:18em;padding:6px 4px" />',
				'<br/><span>输入备注</span><br/><input type="text" value="',
					value,
				'" style="width:18em;padding:6px 4px" />',
			'</div>'
			].join(''),
		init: function(){
			input = this.DOM.content[0].getElementsByTagName('input')[0];
			input2 = this.DOM.content[0].getElementsByTagName('input')[1];
			input3 = this.DOM.content[0].getElementsByTagName('input')[2];
			input4 = this.DOM.content[0].getElementsByTagName('input')[3];
			
			//input.select();
			input.focus();
		},
		ok: function(here){
			input5=input.value+","+input2.value+","+input3.value+","+input4.value;
			return yes && yes.call(this, input5, here);
		},
		cancel: true
	});
};
